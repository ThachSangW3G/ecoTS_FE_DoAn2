...
final kLableTextStyleBigGreen = GoogleFonts.montserrat(
    textStyle: const TextStyle(
        color: AppColors.green, fontWeight: FontWeight.w700, fontSize: 30.0));

final kLableTextStyleMediumGreen = GoogleFonts.montserrat(
    textStyle: const TextStyle(
        color: AppColors.green, fontWeight: FontWeight.w400, fontSize: 18.0));

final kLableTextStyleLogoScreen = GoogleFonts.montserrat(
    textStyle: const TextStyle(
        color: AppColors.green, fontWeight: FontWeight.bold, fontSize: 30.0));

final kLableTextStyleLogoScreenWhite = GoogleFonts.montserrat(
    textStyle: const TextStyle(
...
final kLableTextStyleTilteGreen = GoogleFonts.montserrat(
    textStyle: const TextStyle(
        color: AppColors.green, fontWeight: FontWeight.w700, fontSize: 18.0));

final kLableTextStyleTilte22Green = GoogleFonts.montserrat(
    textStyle: const TextStyle(
...
final kLableTilte16Black = GoogleFonts.montserrat(
    textStyle: const TextStyle(fontWeight: FontWeight.w700, fontSize: 16.0));
...
final kLableTextWhiteW600 = GoogleFonts.montserrat(
    textStyle: const TextStyle(
  fontSize: 20,
